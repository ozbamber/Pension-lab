...
const nativeFixture = path.join(root, 'tests', 'fixtures', 'payslips', 'synthetic-native-text-payslip.pdf');
const scannedFixture = path.join(root, 'tests', 'fixtures', 'payslips', 'synthetic-scanned-payslip.pdf');
