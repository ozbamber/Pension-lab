...
The fast text-layer benchmark currently reports 79.2% field accuracy, 55.6% critical-document accuracy, and 100.0% validation accuracy across 54 eligible documents. The full browser benchmark, including OCR/image-only processing, reports 60.6% field accuracy, 33.3% critical-document accuracy, and 100.0% validation accuracy across all 66 documents.
